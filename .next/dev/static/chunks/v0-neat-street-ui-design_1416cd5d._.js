...
function Navigation({ currentPage, setCurrentPage, userRole, setUserRole, userEmail, userLabel, onLogout }) {
    ...
    const isAuthenticatedAdmin = ("TURBOPACK compile-time value", "object") !== 'undefined' && sessionStorage.getItem("adminMode") === "true";
    const userNavItems = [
        {
            id: "dashboard",
            label: "Dashboard",
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        isAuthenticatedAdmin && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        userEmail && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "md:hidden",
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                value: currentPage,
...
function Dashboard({ onAddLog }) {
    ...
    const fetchDashboardData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[fetchDashboardData]": async ()=>{
            ...
            try {
                ...
                weeklyLogs?.forEach({
                    "Dashboard.useCallback[fetchDashboardData]": (log)=>{
                        const date = new Date(log.logged_at);
                        const dayName = dayNames[date.getDay()];
                        weeklyMap.set(dayName, (weeklyMap.get(dayName) || 0) + Number(log.weight));
                    }
                }["Dashboard.useCallback[fetchDashboardData]"]);
                const processedWeeklyData = Array.from(weeklyMap.entries()).map({
                    "Dashboard.useCallback[fetchDashboardData].processedWeeklyData": ([name, waste])=>({
                            name,
                            waste: Number(waste.toFixed(1))
                        })
                }["Dashboard.useCallback[fetchDashboardData].processedWeeklyData"]);
        ...
        `).eq('user_id', user.id).gte('logged_at', new Date(today.getTime() - 30 * 24 * 60 * 60 * 1000).toISOString());
                ...
                const totalWeight = Array.from(typeMap.values()).reduce({
                    "Dashboard.useCallback[fetchDashboardData].totalWeight": (sum, item)=>sum + item.value
                }["Dashboard.useCallback[fetchDashboardData].totalWeight"], 0);
                const processedTypeData = Array.from(typeMap.entries()).map({
                    "Dashboard.useCallback[fetchDashboardData].processedTypeData": ([name, data])=>({
                            name,
                            value: totalWeight > 0 ? Math.round(data.value / totalWeight * 100) : 0,
                            color: data.color
                        })
                }["Dashboard.useCallback[fetchDashboardData].processedTypeData"]);
                ...
                const todaysWaste = todayLogs?.reduce({
                    "Dashboard.useCallback[fetchDashboardData]": (sum, log)=>sum + Number(log.weight)
                }["Dashboard.useCallback[fetchDashboardData]"], 0) || 0;
                // Fetch monthly waste
                ...
                const monthlyWaste = monthlyLogs?.reduce({
                    "Dashboard.useCallback[fetchDashboardData]": (sum, log)=>sum + Number(log.weight)
                }["Dashboard.useCallback[fetchDashboardData]"], 0) || 0;
                const totalCost = monthlyLogs?.reduce({
                    "Dashboard.useCallback[fetchDashboardData]": (sum, log)=>sum + Number(log.cost)
                }["Dashboard.useCallback[fetchDashboardData]"], 0) || 0;
                ...
                const lastWeekWaste = lastWeekLogs?.reduce({
                    "Dashboard.useCallback[fetchDashboardData]": (sum, log)=>sum + Number(log.weight)
                }["Dashboard.useCallback[fetchDashboardData]"], 0) || 0;
                const thisWeekWaste = weeklyLogs?.reduce({
                    "Dashboard.useCallback[fetchDashboardData]": (sum, log)=>sum + Number(log.weight)
                }["Dashboard.useCallback[fetchDashboardData]"], 0) || 0;
                let weeklyChange = 0;
                if (lastWeekWaste > 0) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Dashboard.useEffect": ()=>{
            ...
            }["Dashboard.useEffect.channel"]).on('postgres_changes', {
                event: '*',
                schema: 'public',
                table: 'profiles'
            }, {
...
_s(Dashboard, "WGQfKX6+oQw3jOVLfwxKoOGTDG0=");
_c = Dashboard;
function Plus({ size }) {
...
function AdminDashboard() {
    ...
    const [users, setUsers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [selectedUser, setSelectedUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [userLogs, setUserLogs] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [loadingUserLogs, setLoadingUserLogs] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [showUserSelector, setShowUserSelector] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const fetchAdminData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AdminDashboard.useCallback[fetchAdminData]": async ()=>{
            const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])();
            try {
                ...
                weeklyLogs?.forEach({
                    "AdminDashboard.useCallback[fetchAdminData]": (log)=>{
                        const date = new Date(log.logged_at);
                        const dayName = dayNames[date.getDay()];
                ...
                }["AdminDashboard.useCallback[fetchAdminData]"]);
                const processedWeeklyData = Array.from(weeklyMap.entries()).map({
                    "AdminDashboard.useCallback[fetchAdminData].processedWeeklyData": ([name, data])=>({
                            name,
                            waste: Number(data.waste.toFixed(0)),
                            users: data.users.size
                        })
                }["AdminDashboard.useCallback[fetchAdminData].processedWeeklyData"]);
                setAdminWasteData(processedWeeklyData);
                // Calculate total waste and average
                const totalWaste = processedWeeklyData.reduce({
                    "AdminDashboard.useCallback[fetchAdminData].totalWaste": (sum, d)=>sum + d.waste
                }["AdminDashboard.useCallback[fetchAdminData].totalWaste"], 0);
        ...
        `).gte('logged_at', weekAgo.toISOString());
                ...
                const totalTypeWeight = Array.from(typeMap.values()).reduce({
                    "AdminDashboard.useCallback[fetchAdminData].totalTypeWeight": (sum, item)=>sum + item.value
                }["AdminDashboard.useCallback[fetchAdminData].totalTypeWeight"], 0);
                const processedTypeData = Array.from(typeMap.entries()).map({
                    "AdminDashboard.useCallback[fetchAdminData].processedTypeData": ([name, data])=>({
                            name,
                            value: totalTypeWeight > 0 ? Math.round(data.value / totalTypeWeight * 100) : 0,
                            color: data.color
                        })
                }["AdminDashboard.useCallback[fetchAdminData].processedTypeData"]);
        ...
        `);
                if (routes) {
                    const processedRoutes = routes.map({
                        "AdminDashboard.useCallback[fetchAdminData].processedRoutes": (route)=>({
                                name: route.name,
                    ...
                    }["AdminDashboard.useCallback[fetchAdminData].processedRoutes"]);
                    setVehicleData(processedRoutes);
                    const activeRoutes = routes.filter({
                        "AdminDashboard.useCallback[fetchAdminData]": (r)=>r.status === 'active'
                    }["AdminDashboard.useCallback[fetchAdminData]"]).length;
                    const fleetCosts = processedRoutes.reduce({
                        "AdminDashboard.useCallback[fetchAdminData].fleetCosts": (sum, r)=>sum + r.cost
                    }["AdminDashboard.useCallback[fetchAdminData].fleetCosts"], 0);
                    setStats({
                        totalWaste,
    ...
    const fetchUserLogs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AdminDashboard.useCallback[fetchUserLogs]": async (userId)=>{
        ...
        `).eq('user_id', userId).order('logged_at', {
                ...
                if (logs) {
                    const formattedLogs = logs.map({
                        "AdminDashboard.useCallback[fetchUserLogs].formattedLogs": (log)=>({
                                id: log.id,
                    ...
                    }["AdminDashboard.useCallback[fetchUserLogs].formattedLogs"]);
    ...
    }["AdminDashboard.useCallback[fetchUserLogs]"], []);
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                    ...
                    children: [
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        showUserSelector && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    users.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        ...
                                                        lineNumber: 569,
                                                        columnNumber: 23
                                                    }, this) : users.map((user)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        selectedUser && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        loadingUserLogs ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            lineNumber: 607,
                            columnNumber: 13
                        }, this) : selectedUser ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "overflow-x-auto",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                    className: "w-full text-sm",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("thead", {
                                            className: "bg-muted/40 border-b border-border",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                            children: userLogs.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    colSpan: 6,
                                                ...
                                                lineNumber: 626,
                                                columnNumber: 21
                                            }, this) : userLogs.map((log)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                    className: "border-b border-border/50 hover:bg-muted/20 transition-colors",
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                ...
                                userLogs.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            lineNumber: 612,
                            columnNumber: 13
                        }, this) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "py-12 text-center",
                            children: [
...
_s(AdminDashboard, "FDdWFGMsNMbKtxRfBIY4YF01hzQ=");
_c = AdminDashboard;
var _c;
...
function TrashTracker({ onAddLog }) {
    ...
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const fetchTrashData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "TrashTracker.useCallback[fetchTrashData]": async ()=>{
            const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])();
            try {
                const { data: { user } } = await supabase.auth.getUser();
                if (!user) return;
                ...
                if (types) {
                    setWasteTypes(types.map({
                        "TrashTracker.useCallback[fetchTrashData]": (t)=>t.name
                    }["TrashTracker.useCallback[fetchTrashData]"]));
                }
        ...
        `).eq('user_id', user.id).order('logged_at', {
                ...
                if (logs) {
                    const formattedLogs = logs.map({
                        "TrashTracker.useCallback[fetchTrashData].formattedLogs": (log)=>({
                                id: log.id,
                    ...
                    }["TrashTracker.useCallback[fetchTrashData].formattedLogs"]);
        ...
        `).eq('user_id', user.id).gte('logged_at', threeWeeksAgo.toISOString()).order('logged_at', {
                ...
                if (trendLogs) {
                    ...
                    trendLogs.forEach({
                        "TrashTracker.useCallback[fetchTrashData]": (log)=>{
                            const typeName = log.waste_types?.name || 'Unknown';
                    ...
                    const processedTrendData = Array.from(trendMap.entries()).map({
                        "TrashTracker.useCallback[fetchTrashData].processedTrendData": ([name, data])=>({
                                name,
                                week1: Number(data.week1.toFixed(1)),
                                week2: Number(data.week2.toFixed(1)),
                                week3: Number(data.week3.toFixed(1))
                            })
                    }["TrashTracker.useCallback[fetchTrashData].processedTrendData"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TrashTracker.useEffect": ()=>{
            ...
            const channel = supabase.channel('trash-tracker-realtime').on('postgres_changes', {
                ...
                "TrashTracker.useEffect.channel": (payload)=>{
                    console.log('Real-time update received:', payload);
                    fetchTrashData(); // Refresh data on any change
                }
            }["TrashTracker.useEffect.channel"]).subscribe();
            // Cleanup subscription on unmount
            return ({
                "TrashTracker.useEffect": ()=>{
                    supabase.removeChannel(channel);
...
_s(TrashTracker, "NpWj4e6ryxxSbs91sboxBusYjCM=");
_c = TrashTracker;
var _c;
...
function AddWasteLog({ onClose }) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const isAdminMode = ("TURBOPACK compile-time value", "object") !== 'undefined' && sessionStorage.getItem("adminMode") === "true";
            const { data: { user } } = await supabase.auth.getUser();
            if (!user && !isAdminMode) {
...
const iconMap = {
    ...
    Shield: __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$shield$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Shield$3e$__["Shield"],
    Recycle: __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$recycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Recycle$3e$__["Recycle"]
};
function Achievements() {
    ...
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const fetchAchievements = (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Achievements.useCallback[fetchAchievements]": async ()=>{
            const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])();
            try {
                const { data: { user } } = await supabase.auth.getUser();
                if (!user) return;
        ...
        `).eq('user_id', user.id);
                if (userAchievements && userAchievements.length > 0) {
                    const formattedAchievements = userAchievements.map({
                        "Achievements.useCallback[fetchAchievements].formattedAchievements": (ua)=>({
                    ...
                    }["Achievements.useCallback[fetchAchievements].formattedAchievements"]);
                    ...
                    if (allAchievements) {
                        const formattedAchievements = allAchievements.map({
                            "Achievements.useCallback[fetchAchievements].formattedAchievements": (a)=>({
                                    id: a.id,
                                    name: a.name,
    ...
    }["Achievements.useCallback[fetchAchievements]"], []);
    // Set up real-time subscription
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Achievements.useEffect": ()=>{
            ...
            const channel = supabase.channel('achievements-realtime').on('postgres_changes', {
                ...
                "Achievements.useEffect.channel": (payload)=>{
                    console.log('Achievements update:', payload);
                    fetchAchievements();
                }
            }["Achievements.useEffect.channel"]).subscribe();
            // Cleanup subscription on unmount
            return ({
                "Achievements.useEffect": ()=>{
                    supabase.removeChannel(channel);
...
_s(Achievements, "PNM125hcaZLnZriNkIeBkKR7b1c=");
_c = Achievements;
var _c;
...
function DashboardClient({ user, isAdmin, username }) {
    ...
    const [userRole, setUserRole] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("user");
    const [isAuthenticatedAdmin, setIsAuthenticatedAdmin] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
...
_s(DashboardClient, "OxDn8ixd4P7iSwXhPl/j/iMrFfs=", false, function() {
    return [
...
"[project]/v0-neat-street-ui-design/app/dashboard/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/v0-neat-street-ui-design/node_modules/next/navigation.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/v0-neat-street-ui-design/lib/supabase/client.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$components$2f$dashboard$2d$client$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/v0-neat-street-ui-design/components/dashboard-client.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function DashboardPage() {
    _s();
    const [user, setUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [username, setUsername] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [isAdmin, setIsAdmin] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardPage.useEffect": ()=>{
            const checkAuth = {
                "DashboardPage.useEffect.checkAuth": async ()=>{
                    ...
                    const adminMode = ("TURBOPACK compile-time truthy", 1) ? sessionStorage.getItem("adminMode") : "TURBOPACK unreachable";
                    if (adminMode === "true") {
                        setIsAdmin(true);
                        setUser({
                            email: "Admin User",
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$components$2f$dashboard$2d$client$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
        user: user,
        isAdmin: isAdmin,
        username: username
    }, void 0, false, {
...
_s(DashboardPage, "411xM/sJxsSqyO2V5RDwS006J0I=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$v0$2d$neat$2d$street$2d$ui$2d$design$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=v0-neat-street-ui-design_1416cd5d._.js.map